package com.jdktomcat.mybatis.alias;
...
import com.jdktomcat.mybatis.dom.model.Package;
...
public class ConfigPackageAliasResolver extends PackageAliasResolver{
  ...
  public Collection<String> getPackages(@Nullable PsiElement element) {
    ...
    MapperUtils.processConfiguredPackage(project, new Processor<com.jdktomcat.mybatis.dom.model.Package>() {
      @Override
